...
SendSuccessSlackMessage "New revision of Victor sound bank assetshave been checked in.`nSVN revision: *$soundbanks_revision* `nSVN branch: *$branch* `nTeamCity build: *$build_number*" $revision_commit_log
