...
public:
  ...
  AudioPlayingId PostAudioEvent( const std::string& eventName,
                                 AudioGameObject gameObjectId = kInvalidAudioGameObject,
                                 AudioCallbackContext* callbackContext = nullptr );
  
  AudioPlayingId PostAudioEvent( AudioEventId eventId,
                                 AudioGameObject gameObjectId = kInvalidAudioGameObject,
                                 AudioCallbackContext* callbackContext = nullptr );
  ...
  void StopAllAudioEvents( AudioGameObject gameObjectId = kInvalidAudioGameObject );
  
  bool SetState( AudioStateGroupId stateGroupId,
                 AudioStateId stateId ) const;
  
  bool SetSwitchState( AudioSwitchGroupId switchGroupId,
                       AudioSwitchStateId switchStateId,
                       AudioGameObject gameObjectId ) const;
  
  bool SetParameter( AudioParameterId parameterId,
  ...
  bool SetParameterWithPlayingId( AudioParameterId parameterId,
                                  AudioRTPCValue rtpcValue,
