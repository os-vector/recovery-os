...
#define LOG_DEBUG(m, ...)              LOG(LogLevelDebug, "DEBUG", __FILE__, __LINE__, m, ##__VA_ARGS__)
#define LOG_TRACE(m, ...)              LOG(LogLevelTrace, "TRACE", __FILE__, __LINE__, m, ##__VA_ARGS__)
#define LOG_INFO(m, ...)               LOG(LogLevelInfo, "INFO", __FILE__, __LINE__, m, ##__VA_ARGS__)
#define LOG_WARN(m, ...)               LOG(LogLevelWarn, "WARNING", __FILE__, __LINE__, m, ##__VA_ARGS__)
#define LOG_ERROR(m, ...)              LOG(LogLevelError, "ERROR", __FILE__, __LINE__, m, ##__VA_ARGS__)
#else
#define LOG_DEBUG(m, ...)
#define LOG_TRACE(m, ...)
#define LOG_INFO(m, ...)
