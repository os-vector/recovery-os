...
namespace Cozmo {
  ...
  extern s32 gFaceDisplayWidth;
  extern s32 gFaceDisplayHeight;
  extern s32 gFaceDisplayNumPixels;
  ...
  #define FACE_DISPLAY_WIDTH           (gFaceDisplayWidth)
  #define FACE_DISPLAY_HEIGHT          (gFaceDisplayHeight)
  #define FACE_DISPLAY_NUM_PIXELS      (gFaceDisplayNumPixels)
  const s32 FACE_DISPLAY_HORIZONTAL_BUFFER = 24;
  const s32 FACE_DISPLAY_VERTICAL_BUFFER = 16;

  //const s32 FACE_DISPLAY_NUM_PIXELS = FACE_DISPLAY_WIDTH * FACE_DISPLAY_HEIGHT;
  //inline s32 FACE_DISPLAY_NUM_PIXELS() { return gFaceDisplayNumPixels; }
